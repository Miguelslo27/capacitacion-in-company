<?php
/**
 * Template for displaying default template Icon Box element kindergarten-layout-4.
 *
 * This template can be overridden by copying it to yourtheme/builderpress/icon-box/kindergarten-layout-4.php.
 *
 * @author      ThimPress
