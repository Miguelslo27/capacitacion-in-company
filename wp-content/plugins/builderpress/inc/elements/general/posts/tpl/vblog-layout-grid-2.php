            ...
            <div class="grid-item <?php echo $size ?>">
                <div class="item-post <?php echo $class_format; ?>  <?php echo $feature_item; ?>">
                    ...
                    if ( has_post_format( 'link' ) && thim_meta( 'thim_link_url' ) && thim_meta( 'thim_link_text' ) ) {
                        ...
                        <a href="<?php echo esc_url( get_permalink() ); ?>" class="btn-readmore btn-small shape-round"><?php echo esc_html__( 'Read More', 'video-blog' ); ?></a>
                        ...
                        <?php if ( get_theme_mod( 'show_sharing', false ) ) :?>
                            <div class="share">
                                <div class="wrap-text">
                        <span class="text">
                            <?php echo esc_html('SHARE THIS ARTICLE','video-blog')?>
                        </span>
