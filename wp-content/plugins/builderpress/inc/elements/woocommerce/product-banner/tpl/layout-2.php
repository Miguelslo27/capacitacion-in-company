<?php
/**
 * Template for displaying default template product banner element layout 2.
 *
 * This template can be overridden by copying it to yourtheme/builderpress/product-banner/layout-2.php.
 *
 * @author      ThimPress
...
<div class="group-banner clearfix">
    <?php
    $loop = 1;
    foreach ( $params['images-2'] as $image ) {
                        ...
                        <div class="flag">
                            <div class="flag-content">
                                ...
                                <?php if ( isset($image['flag_price']) ) { ?>
                                    <span class="price">
                                        <?php echo esc_attr( $image['flag_price'] ) ?>
                                        <!-- wp-content\plugins\builderpress\inc\elements\woocommerce\product-banner\tpl\layout-2.php -->
                                        <span>+ IVA</span>
                                    </span>
                                <?php } ?>
                            </div>
