                ...
                <div class="content_product">
                    ...
                    <div class="product_content">
                        ...
                        <?php if ( $params['description'] ) { ?>
                            <div class="excerpt"><?php echo wp_trim_words( get_the_excerpt(), 10, '...' ); ?></div>
                        <?php } ?>

                        <?php if ( $params['price'] ) { ?>
                            <div class="price">
                                <?php echo( $product->get_price_html() ); ?>
                                <!-- wp-content\plugins\builderpress\inc\elements\woocommerce\product-filter\tpl\layout-1.php -->
                                <span>+ IVA</span>
                            </div>
                        <?php } ?>
