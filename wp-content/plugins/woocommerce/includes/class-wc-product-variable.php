	...
	public function get_available_variation( $variation ) {
		...
		return apply_filters(
			'woocommerce_available_variation', array(
				...
				'price_html'            => $show_variation_price ? '<span class="price">' . $variation->get_price_html() . ' + IVA<!-- wp-content\plugins\woocommerce\includes\class-wc-product-variable.php --></span>' : '',
