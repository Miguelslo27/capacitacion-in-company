...
<div class="slide-category-course js-call-slick-col" dir="rtl" data-rtl="1" data-numofslide="<?php echo $params['items_visible']; ?>" data-numofscroll="1" data-loopslide="0" data-autoscroll="0" data-speedauto="6000" data-respon="<?php echo $params['items_visible']; ?>, 1], [<?php echo $params['items_visible']; ?>, 1], [<?php echo $params['items_tablet']; ?>, 1], [<?php echo $params['items_mobile']; ?>, 1], [<?php echo $params['items_mobile']; ?>, 1]">
