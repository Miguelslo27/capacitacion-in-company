...
<?php if ( get_option( 'users_can_register' ) ) {
    ...
    <div class="login-form-wrap">
        <h4 class="subtitle"><?php esc_html_e( 'Registro', 'builderpress' ); ?></h4>
        <h2 class="title"><?php esc_html_e( 'Regístrate y comienza a amprender', 'builderpress' ); ?></h2>

        <form name="registerform" id="register-form"
              action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>"
              method="post" novalidate="novalidate">
            <p>
                <input required placeholder="<?php esc_attr_e( 'Usuario', 'builderpress' ); ?>" type="text"
                       name="user_login" id="user_login" class="input"/>
            </p>

            <p>
                <input required placeholder="<?php esc_attr_e( 'Correo Electrónico', 'builderpress' ); ?>"
                       type="email" name="user_email" id="user_email" class="input"/>
            </p>

            <p>
                <input required placeholder="<?php esc_attr_e( 'Contraseña', 'builderpress' ); ?>"
                       type="password" name="password" id="password" class="input"/>
            </p>

            <p>
                <input required placeholder="<?php esc_attr_e( 'Confirma tu Contraseña', 'builderpress' ); ?>"
            ...
            <div class="wrap-fields">
                ...
                <p class="submit login-submit">
                    <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large"
                           value="<?php esc_attr_e( 'Registrarme', 'builderpress' ); ?>"/>
                </p>
        ...
        <p class="link-bottom"><?php esc_html_e( '¿Ya eres un miembro? ', 'builderpress' ); ?><a
                    href="<?php echo esc_url( bp_get_login_page_url() ); ?>"><?php esc_html_e( 'Inicia Sesión', 'builderpress' ); ?></a>
        </p>
