...
if ($hide_page_title != '1') :
  ?>
  <!-- wp-content\themes\ivy-school-child\templates\page-title\page-title.php -->
        ...
        <?php if ($hide_title != '1') : ?>
          <div class="content container">
            ...
            if ((is_category() || is_archive() || is_search() || is_404())) {
              ...
              echo '</' . $typography . '>';
              if (category_description($cat_ID) != '') { } else {
                if ($hiden_subtitle != '1') :
              ...
              if (is_single()) {
                ...
                if (get_post_type() == "our_team") {
                  echo '<' . $typography . '>' . esc_html__('Nuestro equipo', 'ivy-school');
                  echo '</' . $typography . '>';
                }
                if (get_post_type() == "tp_event") {
                  echo '<' . $typography . '>' . esc_html__('Eventos', 'ivy-school');
                  echo '</' . $typography . '>';
                }
                if (get_post_type() == "product") {
                  echo '<' . $typography . '>' . esc_html__('Productos', 'ivy-school');
                  echo '</' . $typography . '>';
                }
                if (get_post_type() == "lpr_course" || get_post_type() == "lpr_quiz" || get_post_type() == "lp_course" || get_post_type() == "lp_quiz" || thim_check_is_course() || thim_check_is_course_taxonomy()) {
                  echo '<' . $typography . '>' . esc_html__('Cursos', 'ivy-school');
                  echo '</' . $typography . '>';
                }
                if (get_post_type() == "lp_collection") {
                  echo '<' . $typography . '>' . esc_html__('Colecciones', 'ivy-school');
                  echo '</' . $typography . '>';
                }
                if (get_post_type() == "testimonials") {
                  echo '<' . $typography . '>' . esc_html__('Testimonios', 'ivy-school');
                  echo '</' . $typography . '>';
                }
              } else {
                echo '<' . $typography . '>';
