...
bp_element_search.searchHover();$sc_wrapper.removeClass('loading')},})}},searchHover:function(){var $sc_wrapper=$('.bp-element-search .search-form');$sc_wrapper.on('hover','.list-search li',function(){$sc_wrapper.find('.list-search li').removeClass('ob-selected');$(this).addClass('ob-selected')})},searchFocus:function(){var $sc_wrapper=$('.bp-element-search .search-form');$sc_wrapper.each(function(index,form){$(form).on('hover','form',function(){$(form).find('.search-field').focus()})})},search_popup:function(){var $search_button=$('.search-button'),$header=$('#masthead.sticky-header'),windoH=$(window).height();$('.bp-element-search').find('.search-form').css('height',windoH);$search_button.live('click',function(event){$(this).parents('.bp-element-search').find('.search-form').addClass('open');$(document).on('keydown',function(e){if(e.keyCode===27){$(this).find('.search-form').removeClass('open')}})});$(document).on('click','.close-form',function(e){e.stopPropagation();$(this).parents('.search-form').removeClass('open')});$(window).scroll(function(){var window2=windoH;if($header.hasClass('menu-hidden')){window2=windoH+$header.height()+40;$('.bp-element-search.layout-1').find('.search-form').css('height',window2)}})}}})(jQuery);
...
(function($){'use strict';$(document).ready(function(){thim_startertheme.ready()});$(window).load(function(){thim_startertheme.load()});var thim_startertheme={ready:function(){this.thim_tabs()},load:function(){},thim_tabs:function(){try{$('.js-call-tabs').each(function(){var navTabs=$(this).find('.thim-nav-tabs');var contentTabs=$(this).find('.thim-content-tabs');$(contentTabs).find('.tab-panel').hide();var getPanelActive=$(navTabs).find('.item-nav.active').data('panel');$(contentTabs).find(".tab-panel[data-nav='"+getPanelActive+"']").show();$(contentTabs).find(".tab-panel[data-nav='"+getPanelActive+"']").addClass('active');$(navTabs).find('.item-nav').each(function(){$(this).on('click',function(){var getPanel=$(this).data('panel');$(contentTabs).find('.tab-panel').hide();$(contentTabs).find('.tab-panel').removeClass('active');$(navTabs).find('.item-nav').removeClass('active');$(contentTabs).find(".tab-panel[data-nav='"+getPanel+"']").show();$(contentTabs).find(".tab-panel[data-nav='"+getPanel+"']").addClass('active');$(this).addClass('active')})})})}catch(er){console.log(er)}},}})(jQuery);
...
bp_element_search_courses.searchHover();$sc_wrapper.removeClass('loading')},})}},searchHover:function(){var $sc_wrapper=$('.bp-element-search-courses .search-form');$sc_wrapper.on('hover','.list-search li',function(){$sc_wrapper.find('.list-search li').removeClass('ob-selected');$(this).addClass('ob-selected')})},searchFocus:function(){var $sc_wrapper=$('.bp-element-search-courses .search-form');$sc_wrapper.each(function(index,form){$(form).on('hover','form',function(){$(form).find('.search-field').focus()})})},search_courses_popup:function(){var $search_button=$('.search-button'),$header=$('#masthead.sticky-header'),windoH=$(window).height();$('.bp-element-search-courses').find('.search-form').css('height',windoH);$search_button.live('click',function(event){$(this).parents('.bp-element-search-courses').find('.search-form').addClass('open');$(document).on('keydown',function(e){if(e.keyCode===27){$(this).find('.search-form').removeClass('open')}})});$(document).on('click','.close-form',function(e){e.stopPropagation();$(this).parents('.search-form').removeClass('open')});$(window).scroll(function(){var window2=windoH;if($header.hasClass('menu-hidden')){window2=windoH+$header.height()+40;$('.bp-element-search-courses.layout-1').find('.search-form').css('height',window2)}})}}})(jQuery);
;
;
...
(function($){"use strict";$(document).ready(function(){thim_startertheme.ready()});$(window).load(function(){thim_startertheme.load()});var thim_startertheme={ready:function(){this.calendar_jqueryui()},load:function(){},calendar_jqueryui:function(){try{$(".js-call-calendar").each(function(){var arrayDays=[''];var arrayLinks=[''];var link='';if($(this).data('days')!=null){arrayDays=$(this).data('days')}
if($(this).data('link')!=null){arrayLinks=$(this).data('link')}
$(this).datepicker({firstDay:1,dateFormat:'yy-mm-dd',onSelect:function(dateSelected,obj){for(var i=0;i<arrayDays.length;i++){if(arrayDays[i]==dateSelected){window.open(arrayLinks[i])}}},beforeShowDay:function(d){var date=d.getFullYear()+'-'+(d.getMonth()+1)+'-'+d.getDate();for(var i=0;i<arrayDays.length;i++){if(arrayDays[i]==date){return[!0,"have-event",""]}}
...
/*! dialogs-manager v4.7.1 | (c) Kobi Zaltzberg | http://github.com/kobizz/dialogs-manager/blob/master/LICENSE.txt
 2019-01-13 15:53 */
