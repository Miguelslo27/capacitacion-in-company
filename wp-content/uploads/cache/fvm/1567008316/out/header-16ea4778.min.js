...
(function($){'use strict';$(document).ready(function(){bp_starter.ready()});$(window).load(function(){bp_starter.load()});var bp_starter={ready:function(){this.slide_slick_col();this.bp_hover_element();this.element_responsive()},load:function(){},slide_slick_col:function(){var rightToLeft=!1;var verticalSlide=!1;var verticalSwipe=!1;var customdot=!1;var numOfSlide=4;var numOfScroll=4;var loopSlide=!1;var autoScroll=!1;var speedAuto=5000;var respon=[[4,4],[3,3],[2,2],[1,1],[1,1]]
$('.js-call-slick-col').each(function(){var wrapSlick=$(this);var slideSlick=$(this).find('.slide-slick');var showDot=!1;if($(wrapSlick).find('.wrap-dot-slick').length>0){showDot=!0}
var showArrow=!1;if($(wrapSlick).find('.wrap-arrow-slick').length>0){showArrow=!0}
numOfSlide=Number($(this).data('numofslide'));numOfScroll=Number($(this).data('numofscroll'));speedAuto=Number($(this).data('speedauto'));if($(this).data('rtl')=='1'){rightToLeft=!0}else{rightToLeft=!1}
if($(this).data('loopslide')=='1'){loopSlide=!0}else{loopSlide=!1}
if($(this).data('autoscroll')=='1'){autoScroll=!0}else{autoScroll=!1}
if($(this).data('customdot')=='1'){customdot=!0}else{customdot=!1}
if($(this).data('verticalslide')=='1'){verticalSlide=!0}else{verticalSlide=!1}
if($(this).data('verticalswipe')=='1'){verticalSwipe=!0}else{verticalSwipe=!1}
